...
dc_leaflet.leafletBase = function(_chart) {
    ...
    _legend.onAdd = function (map) {  
      ...
      _legend.update = function () {    
        ...
        if (numCharts == 4) {      
          minValue = choro.colorDomain()[0];
          maxValue = choro.colorDomain()[1];
          palette = choro.colors().range();
          colorLength = choro.colors().range().length;
    ...
    _chart._doRender = function() {
        ...
        console.log("call legend addTo map")
